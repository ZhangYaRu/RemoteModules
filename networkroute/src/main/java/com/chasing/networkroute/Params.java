...
import com.chasing.networkroute.observers.ByteConsoleLogger;
import com.chasing.networkroute.observers.ByteFileLogger;
import com.chasing.networkroute.observers.InMemoryLogger;
import com.chasing.networkroute.observers.SocketForwardingObserver;
import com.chasing.networkroute.observers.StringConsoleLogger;
import com.chasing.networkroute.observers.StringFileLogger;
...
public class Params {
  ...
  private int localRecievePort = -1;
  ...
  /**
   * @param localRecievePort Source port where to wait for tunnel initiating connections on localhost.
   ...
   */
  public Params(int localRecievePort, int localSendPort,  String remoteHost, int remotePort) {
    this.localRecievePort = localRecievePort;
   ...
   */
  public int getLocalRecievePort() {
    return localRecievePort;
  }
  ...
  /**
   * @param localRecievePort The port to bind on localhost and wait for tunnel initialization connections.
   */
  public void setLocalRecievePort(int localRecievePort) {
    this.localRecievePort = localRecievePort;
  }
...
//    observersDown.add(new SocketForwardingObserver(remoteHost, remotePort));
  ...
  public String toString() {
    return "Params{" +
            "encoding='" + encoding + '\'' +
            ", localRecievePort=" + localRecievePort +
